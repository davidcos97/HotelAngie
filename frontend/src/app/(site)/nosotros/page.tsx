...
const VALUES = [
  ...
  { icon: Users2, title: "Comunidad real", description: "Creamos espacios compartidos que conectan viajeros, locales y creadores." },
  { icon: Sparkles, title: "Diseño con propósito", description: "Cada rincón está pensado para inspirar calma, foco y creatividad." },
  { icon: Globe2, title: "Mentalidad global", description: "Recibimos huéspedes de todo el mundo con la misma calidez del Eje Cafetero." }
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <ScrollReveal>
            <SectionHeading
              ...
              description={`${HOTEL.name} nació en 2023 con una convicción: viajar no debería significar sentirse solo. Convertimos un edificio en Pereira, cerca del lago, en un hogar compartido para nómadas digitales, creativos y viajeros curiosos.`}
            />
          </ScrollReveal>
          <ScrollReveal delay={0.15}>
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-soft">
              <Image
                src={BRAND_ASSETS.deskObjects.src}
                alt={BRAND_ASSETS.deskObjects.alt}
                fill
                loading="lazy"
